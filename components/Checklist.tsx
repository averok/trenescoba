  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl shadow-lg border border-slate-700 overflow-hidden">
      <div className="p-4 border-b border-slate-700">
        <h2 className="text-2xl font-bold text-center text-white mb-3">{title}</h2>
        {!isReadOnly && (
            ...
            <button
                ...
                aria-label="Marcar toda como No"
            >
                Toda No
            </button>
            <button
            ...
            <button
                ...
                aria-label="Marcar toda como Si"
            >
                Toda Si
            </button>
            </div>
      ...
      <ul className="divide-y divide-slate-700/50 p-1">
